<template>
  <div>
    <v-row align="center" justify="space-around">
      <Key v-bind:keyValue="1" v-on:key-click="onKeyClicked" />
      <Key v-bind:keyValue="2" v-on:key-click="onKeyClicked" />
    ...
    <v-row align="center" justify="space-around">
      ...
      <Key v-bind:keyValue="7" v-on:key-click="onKeyClicked" />
